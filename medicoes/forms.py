...
from .models import MedicaoGravimetrica, CustomUser, validar_coordenadas_brasil, validar_gravidade_range, AreaOfExpertise
...
class MedicaoGravimetricaForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        if latitude and longitude:
            try:
                validar_coordenadas_brasil(float(latitude), float(longitude))
            except forms.ValidationError as e:
                self.add_error(None, f'Coordenadas: {e.message}')
