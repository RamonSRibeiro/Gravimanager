        ...
        if form.is_valid():
            ...
            try:
                ...
                for _, linha in df.iterrows():
                    ...
                    MedicaoGravimetrica.objects.create(
                        codigo_estacao=str(linha["codigo_estacao"]).strip(),
                        nome_estacao=str(linha["nome_estacao"]).strip(),
                        latitude=float(linha["latitude"]),
                        longitude=float(linha["longitude"]),
                        valor_gravidade=float(linha["valor_gravidade"]),
                        data_medicao=linha["data_medicao"],
                    )
